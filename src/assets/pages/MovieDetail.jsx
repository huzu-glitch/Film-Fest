          ...
          <p className="my-7 flex flex-wrap gap-2">
            {
              data.genres?.map((genre)=>(
                <span key={genre.id} className="mr-2 border border-gray-400 rounded dark:border-gray-600 p-2">{genre.name}</span>
              ))
            }
          </p>
            ...
            <div className="flex items-center">
                ...
                <span className="text-gray-900  dark:text-white">{data.score_count}</span>
            </div>
            <p className="my-4">
            ...
            <p className="my-4">
              ...
              <a href={`https://www.imdb.com/title/${data.imdb_id}`} target="_blank" rel="noopener noreferrer">{data.imdb_id}</a>
            </p>
        </div>
      </section>
    </main>
